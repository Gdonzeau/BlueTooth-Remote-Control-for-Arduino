...
class OneTextFieldLine: UIView {
    ...
    func setupView() {
        ...
        title.text = "Save's name : "
        dataName01.placeholder = "save's name"
        dataName01.backgroundColor = .lightGray
        dataName01.contentMode = .scaleAspectFit
        
        let horizontalStackView = UIStackView(arrangedSubviews: [title,dataName01])
        ...
        NSLayoutConstraint.activate([
            ...
            dataName01.heightAnchor.constraint(equalToConstant: 32)
        ])
